...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        logo.setText("FMOcc");
        bg.add(logo, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 60, -1, -1));

        tienda.setBackground(new java.awt.Color(0, 134, 190));
        tienda.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/images/tienda.png"))); // NOI18N
        bg.add(tienda, new org.netbeans.lib.awtextra.AbsoluteConstraints(468, 0, 730, 500));
